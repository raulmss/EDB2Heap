...
public class FilaBanco implements Observer {
    ...
    public void update(Pessoa pessoa) {
        //chama heap a partir do indice dessa pessoa
        heapifyUp(returnIndex(pessoa));
    }
    public int returnIndex(Pessoa pessoa){
        int index = 0;
        ...
        System.out.println(pessoa.getNome()+"não está na fila.");
        return -1;
    }
}
//